...
namespace MM.Attributes.Editor
{
    public abstract class PropertyDrawerBase : PropertyDrawer
    {
        ...
        {
            float indentLength = MMEditorGUI.GetIndentLength(rect);
            ...
            MMEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
