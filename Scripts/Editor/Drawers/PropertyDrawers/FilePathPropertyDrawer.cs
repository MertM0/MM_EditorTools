...
namespace MM.Attributes.Editor
{
    ...
    public class FilePathPropertyDrawer : PropertyDrawerBase
    {
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType == SerializedPropertyType.String)
            {
                ...
                Rect textFieldRect = new Rect(
                    ...
                    rect.y,
                    rect.width - EditorGUIUtility.labelWidth - BrowseButtonWidth - MMEditorGUI.HorizontalSpacing,
                    EditorGUIUtility.singleLineHeight);
                ...
                if (ShouldShowFileNotFoundWarning(property))
                {
                    Rect helpBoxRect = new Rect(
                        rect.x + MMEditorGUI.GetIndentLength(rect),
                        rect.y + EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing,
                        rect.width - MMEditorGUI.GetIndentLength(rect),
                        GetHelpBoxHeight());

                    string message = string.Format(FileNotFoundWarningMessage, property.stringValue);
                    MMEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, property.serializedObject.targetObject);
                }
            }
            else
            {
            ...
            if (browseClicked)
            {
                ...
                EditorApplication.delayCall += () =>
                {
                    ...
                    selectedPath = capturedAttribute.RelativePath
                        ? MMPathUtility.GetProjectRelativePath(selectedPath)
                        : MMPathUtility.NormalizePath(selectedPath);
        ...
        private static bool ShouldShowFileNotFoundWarning(SerializedProperty property)
        {
            ...
            return !File.Exists(MMPathUtility.GetProjectAbsolutePath(property.stringValue));
        }
    }
}
